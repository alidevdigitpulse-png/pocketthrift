            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h4 class="card-title">Edit Offer: {{ $offer->title }}</h4>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.offer.update', $offer->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="affiliate_links" id="affiliate_links" class="form-control @error('affiliate_links') is-invalid @enderror" rows="3">{{ old('affiliate_links', $offer->affiliate_links) }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="new_recently_updated" id="new_recently_updated" class="form-check-input" value="1" {{ old('new_recently_updated', $offer->new_recently_updated) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="terms_and_conditions" id="terms_and_conditions" class="form-control @error('terms_and_conditions') is-invalid @enderror" rows="4">{{ old('terms_and_conditions', $offer->terms_and_conditions) }}</textarea>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="form-check mt-4">
                                        <input type="checkbox" name="active" id="active" class="form-check-input" value="1" {{ old('active', $offer->active) ? 'checked' : '' }}>
