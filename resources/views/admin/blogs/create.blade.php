                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="meta_robots" id="meta_robots"
                                            ...
                                            <option value="Index, Follow"
                                                {{ old('meta_robots') == 'Index, Follow' ? 'selected' : '' }}>
                                                Index, Follow
                                            </option>
                                            <option value="Noindex, Follow"
                                                {{ old('meta_robots') == 'Noindex, Follow' ? 'selected' : '' }}>
                                                Noindex, Follow
                                            </option>
                                            <option value="Index, Nofollow"
                                                {{ old('meta_robots') == 'Index, Nofollow' ? 'selected' : '' }}>
                                                Index, Nofollow
                                            </option>
                                            <option value="Noindex, Nofollow"
                                                {{ old('meta_robots') == 'Noindex, Nofollow' ? 'selected' : '' }}>
                                                Noindex, Nofollow
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="est_read_time" id="est_read_time"
                                            class="form-control" value="{{ old('est_read_time') }}" min="0">
                                        @error('est_read_time')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="country_codes[]" id="country_codes" class="form-control"
                                                ...
                                                @foreach ($regions as $region)
                                                    <option value="{{ $region->code }}">{{ $region->country }}
                                                        ({{ $region->code }})</option>
                                                @endforeach
                                            </select>
