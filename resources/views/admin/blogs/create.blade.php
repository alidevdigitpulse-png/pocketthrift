                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="url_slug" id="url_slug" class="form-control" value="{{ old('url_slug') }}" required>
                                    @error('url_slug')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <small class="form-text text-muted">Upload a featured image for the blog post</small>
                                    @error('image')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="seo_meta_keyword" id="seo_meta_keyword" class="form-control" rows="3">{{ old('seo_meta_keyword') }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="est_read_time" id="est_read_time" class="form-control" value="{{ old('est_read_time') }}" min="0">
                                    @error('est_read_time')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="blog_table" id="blog_table" class="form-control" value="{{ old('blog_table') }}">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="sort" id="sort" class="form-control" value="{{ old('sort', 0) }}" required>
                                    @error('sort')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="country_codes[]" id="country_codes" class="form-control" multiple>
                                            @foreach($regions as $region)
                                                <option value="{{ $region->code }}">{{ $region->country }} ({{ $region->code }})</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="created_by" id="created_by" class="form-control">
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" {{ old('created_by') == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->email }})</option>
                                        @endforeach
                                    </select>
                                    @error('created_by')
                                        <div class="text-danger">{{ $message }}</div>
