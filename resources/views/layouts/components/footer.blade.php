<footer class="footer-container">
        ...
        <div class="footer-header">
            <h2>Get Best Deals and Coupons With Only PocketThrift</h2>
        ...
        <div class="footer-content">
            ...
            <img src="{{ asset('uploads/logo.png') }}" alt="{{ config('app.name') }}" class="img-fluid" style="max-height: 50px; max-width: 180px; object-fit: contain;">
                ...
                <p class="logo-description">Get Top Deals and Exclusive Discounts on your favorite brands in the 
      ...
      @else
        USA
      @endif
                    Save more with our curated offers and promo codes for a smarter shopping experience.</p>
                {{-- <div class="social-icons">

                    <ul class="">
                        <li><a href="https://www.facebook.com/people/Pocket-Thrift/61562541071877/?mibextid=ZbWKwL"
                                rel="noopener nofollow" target="_blank" title="Facebook">
                                <div
                                    class="">
                                    <svg fill="rgba(255,255,255,1)" height="18" viewBox="0 0 24 24" width="18"
                        ...
                        <li><a href="https://www.instagram.com/pocketthrift1/" rel="noopener nofollow" target="_blank"
                                title="Instagram">
                                <div
                                    class="">
                                    <svg fill="rgba(255,255,255,1)" height="18" viewBox="0 0 24 24" width="18"
                        ...
                        <li><a href="https://x.com/Pocketthrift" rel="noopener nofollow" target="_blank"
                                title="Twitter-x">
                                <div
                                    class="">
                        ...
                        <li><a href="https://www.linkedin.com/in/pocket-thrift-40336131b" rel="noopener nofollow"
                        ...
                        <li><a href="https://www.pinterest.com/pocketthrift1/" rel="noopener nofollow" target="_blank"
                                title="Pinterest">
                                <div
                                    class="">
                                    <svg fill="rgba(255,255,255,1)" height="18" viewBox="0 0 24 24" width="18"
            ...
            <div class="footer-column">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('affiliateDisclaimer') }}">Affiliate Disclaimer</a></li>
                    <li><a href="{{ route('imprint') }}">Imprint</a></li>
                    <li><a href="{{ route('termsofUse') }}">Terms of Use</a></li>
                    <li><a href="{{ route('allRegions') }}">All Regions</a></li>
                </ul>
            </div>
            ...
            <div class="footer-column">
                ...
                <ul>
                    <li><a href="mailto:contact@pocketthrift.com ">Email: contact@pocketthrift.com </a></li>
                </ul>
                <h3 class="pt-5">Follow Us on Social Media</h3>
                <div class="social-icons">
        ...
        <div class="footer-bottom">
            <div class="copyright">PocketThrift © - 2025 All Rights Reserved</div>
