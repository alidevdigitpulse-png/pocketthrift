...
@endphp
    @php
        ...
        $regionCode = $currentRegion->code ?? ($region->code ?? 'us');
        $regions = [
            'us' => 'USA',
            'uk' => 'United Kingdom',
            'au' => 'Australia',
        ...
        // Breadcrumbs
        $breadcrumbs = $meta['breadcrumbs'] ?? [['name' => __('Home'), 'url' => '/'], ['name' => $page->title, 'url' => $path]];
                ...
                <div class="border-top bg-white px-md-2 px-3 mt-4">
                    <div class="container py-3">
                        <ul class="list-unstyled d-flex align-items-center gap-2 mb-0">
                            ...
                            <li class="d-flex align-items-center">
                                <span class="fw-semibold">{{ __('Privacy Policy') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
